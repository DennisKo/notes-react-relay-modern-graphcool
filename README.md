...
Compile + Watch: `yarn relay:watch`
Relay Compiler needs Watchman to run in Watchmode. On MacOS this can be installed by just typing `brew install watchman`. On Ubuntu it can be installed following this [guide](https://medium.com/@vonchristian/how-to-setup-watchman-on-ubuntu-16-04-53196cc0227c).
